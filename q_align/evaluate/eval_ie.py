...
def main(args):
    ...
    image_paths = [
                  "/workspace/temp2/Q-Align/IE-R1-4K/dst_val/",
                  ]
                  

    # json_prefix = "/code/vqa/e-bench-db/"
    jsons = [
        '/workspace/temp2/Q-Align/IE-R1-val-traindst.json',
        #   '/userhome/gaia/gaia.json',
    ]
    ...
    os.makedirs(f"eval_outputs/{os.path.basename(args.model_path)}/", exist_ok=True)
